...
#  WIDGETS-TAB1----------------------------------------------------------------------------
search_label = Label(  tab1, text = 'Search name/ month', bg = bg_color, fg = 'black', font = ( 'crystal', 11 ))
search_entry = Entry(  tab1, bg = 'lightpink' )
search_enter = Button( tab1, text = 'Enter' , bg = bg_color, fg = 'black', font = ( 'crystal', 10 ), command = search )
...
select_button = Button( tab2, text = 'select record', bg = bg_color, fg = 'black',
            font = ( 'crystal', 10 ), command = record_select )

add_name_label  = Label( tab2, text = 'name',  bg = bg_color, fg = 'black', font = ( 'crystal', 10 ) )
add_date_label  = Label( tab2, text = 'date',  bg = bg_color, fg = 'black', font = ( 'crystal', 10 ) )
add_month_label = Label( tab2, text = 'month', bg = bg_color, fg = 'black', font = ( 'crystal', 10 ) )

enter_name  = Entry( tab2, bg = 'lightpink' )
enter_date  = Entry( tab2, bg = 'lightpink' )
enter_month = Entry( tab2, bg = 'lightpink' )

add_button = Button( tab2, text = 'add', bg = bg_color, fg = 'black',
            font = ( 'crystal', 10 ) , command = record_add )
update_button = Button( tab2, text = 'update date/month', bg = bg_color, fg = 'black',
            font = ( 'crystal', 10 ) , command = record_update )
remove_button = Button( tab2, text = 'remove selected', bg = bg_color, fg = 'black',
            font = ( 'crystal', 10 ) , command = record_remove )
